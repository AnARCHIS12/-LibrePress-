...
<head>
    ...
    <meta name="description" content="{{ $description ?? 'CMS Laravel libre, modulaire et auto-hebergeable.' }}">
    @isset($content)
        @if (data_get($content->meta, 'seo.noindex'))
            <meta name="robots" content="noindex,nofollow">
        @endif
        @if (data_get($content->meta, 'seo.canonical_url'))
            <link rel="canonical" href="{{ data_get($content->meta, 'seo.canonical_url') }}">
        @endif
    @endisset
